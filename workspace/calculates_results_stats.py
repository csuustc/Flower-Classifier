...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        A += 1 if results_dic[key][3] + results_dic[key][4] == 2 else 0
        B += results_dic[key][3]
        C += 1 if results_dic[key][3] + results_dic[key][4] == 0 else 0
        E += 1 if results_dic[key][3] + results_dic[key][2] == 2 else 0
        Y += results_dic[key][2]
    D = Z - B
    ...
    results_stats_dic['pct_correct_notdogs'] = C/D * 100 if D != 0 else 0
